...
const {userUpload}  = require("../Middleware/uploadImage");
...
Student_user_routes.patch("/UpdateStudentUser/:id",userUpload.single('image'), updateStudent_user);

Student_user_routes.post("/students/:id/image",userUpload.single('image'), uploadImg);
